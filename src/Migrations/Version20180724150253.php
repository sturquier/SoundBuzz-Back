 ...
 */
final class Version20180724150253 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, person_id INT NOT NULL, type INT NOT NULL, INDEX IDX_1599687217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE favorite_playlist (favorite_id INT NOT NULL, playlist_id INT NOT NULL, INDEX IDX_7DD509DCAA17481D (favorite_id), INDEX IDX_7DD509DC6BBD148 (playlist_id), PRIMARY KEY(favorite_id, playlist_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE music (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, is_explicit TINYINT(1) NOT NULL, downloadable TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, tranfer_at DATETIME NOT NULL, duration DOUBLE PRECISION NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_CD52224AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE artist ADD CONSTRAINT FK_1599687217BBB47 FOREIGN KEY (person_id) REFERENCES person (id)');
        ...
        $this->addSql('ALTER TABLE favorite_playlist ADD CONSTRAINT FK_7DD509DCAA17481D FOREIGN KEY (favorite_id) REFERENCES favorite (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE favorite_playlist ADD CONSTRAINT FK_7DD509DC6BBD148 FOREIGN KEY (playlist_id) REFERENCES playlist (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE favorite_playlist DROP FOREIGN KEY FK_7DD509DCAA17481D');
        ...
        $this->addSql('ALTER TABLE artist DROP FOREIGN KEY FK_1599687217BBB47');
        $this->addSql('ALTER TABLE favorite_playlist DROP FOREIGN KEY FK_7DD509DC6BBD148');
